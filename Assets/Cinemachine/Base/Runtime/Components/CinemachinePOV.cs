...
namespace Cinemachine
{
    ...
    public class CinemachinePOV : CinemachineComponentBase
    {
        ...
        public AxisState m_VerticalAxis = new AxisState(300f, 0.1f, 0.1f, 0f, "Mouse Y", true,0);
        ...
        public AxisState m_HorizontalAxis = new AxisState(300f, 0.1f, 0.1f, 0f, "Mouse X", false,0);
